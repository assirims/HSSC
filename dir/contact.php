...
<fieldset>
<legend><span class='aa'>«· Ê«’· „⁄ «·‰«œÌ</span></legend>

<table border='0' width='100%' id='AutoNumber155'>
    <tr>
      <td width='20%'>ª »—Ìœﬂ «·≈·ﬂ —Ê‰Ì :</td>
      <td width='80%'><input class='addinput' type='text' name='SenderEmail' size='60' dir='ltr' /></td>
    </tr>
    <tr>
      <td width='20%'>ª ⁄‰Ê«‰ «·—”«·… :</td>
      <td width='80%'><input class='addinput' type='text' name='Subject' size='60' /></td>
    </tr>
    <tr>
      <td width='20%'>ª ‰’ «·—”«·… :</td>
      <td width='80%'><textarea class='addinput' name='Message' COLS=80 ROWS=8></textarea></td>
    </tr>";
...
if($SenderEmail == "" OR $Subject == "" OR $Message == ""){
$xxx = "- Â‰«ﬂ √Õœ «·Œ«‰«  ›«—€Â . <a href='javascript:history.back(1)'>⁄Êœ… ··Œ·›</a>";
}else{
$X = @mail ($emailsite,$Subject,$Message,$headers);
If ($X){
