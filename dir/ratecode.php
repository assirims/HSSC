...
if(isset($_GET['rate']) AND isset($_GET['siteid'])){
...
echo '<div align="center"><b>б«нгядя  ённг е–« «бгжёЏ б√дя ёг  » ённге ё»б Ё —… »”нЎ…</b></div>';
}

}else{
echo "<div align='center'><b>ѕќжб ќ«ЎнЅ</b></div>";
if($htmlorphp == 1){
