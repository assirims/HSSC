<?php exit; ?>
1400883595
SELECT s.style_id, c.theme_id, c.theme_data, c.theme_path, c.theme_name, c.theme_mtime, i.*, t.template_path FROM soq_styles s, soq_styles_template t, soq_styles_theme c, soq_styles_imageset i WHERE s.style_id = 4 AND t.template_id = s.template_id AND c.theme_id = s.theme_id AND i.imageset_id = s.imageset_id
79618
a:1:{i:0;a:11:{s:8:"style_id";s:1:"4";s:8:"theme_id";s:1:"4";s:10:"theme_data";s:79208:"/*  phpBB Style Sheet
    --------------------------------------------------------------
...
html, body {
	...
	background-image: url("{T_THEME_PATH}/images/bodybg.png");
...
.forumbg {
	...
	background-image: url("{T_THEME_PATH}/images/ucp.gif");
...
.bg3	{ background-color: #174a68; background-image: url("{T_THEME_PATH}/images/ucp.gif"); background-repeat: repeat-x; }
...
.quick-login-form {
	width: 166px; height: 23px; cursor: text;
...
.toolbar {
	...
	background-repeat: no-repeat;
	margin-bottom: 6px; padding: 10px; padding-top: 12px;
	font-family: "Tahoma", Geneva, sans-serif;
...
.forum-expand {
    ...
    left: 5px;
	top: 7px;
	background-image: url("{T_THEME_PATH}/images/collapse.png");
    height: 8px;
    width: 25px;    
	outline: none;
}
...
.bg3 fieldset.display-options label {color: #ffffff;}
...
.bg3 fieldset.fields1 label {color: #ffffff;}
.bg3 fieldset.fields1 dd {color: #ffffff;}
.bg3 fieldset .right-box label {color: #ffffff;}
.bg3 fieldset.display-actions a {color: #ffffff;}
.bg3 fieldset.forum-selection label {color: #ffffff;}

#attach-panel, #poll-panel {color: #ffffff;}
#attach-panel dt label, #poll-panel dt label, #poll-panel dd label {color: #ffffff;}
";s:10:"theme_path";s:10:"absolution";s:10:"theme_name";s:10:"Absolution";s:11:"theme_mtime";s:10:"1400801491";s:11:"imageset_id";s:1:"4";s:13:"imageset_name";s:10:"Absolution";s:18:"imageset_copyright";s:31:"&copy; www.ChristianBullock.com";s:13:"imageset_path";s:10:"absolution";s:13:"template_path";s:10:"absolution";}}