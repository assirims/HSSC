        ...
        // ]]>
			...
			<ul class="topiclist">
                ...
                <div class="custom-cat-header">
					<dl class="icon">
 						<dt><?php if ($_forumrow_val['S_IS_CAT']) {  ?><div style="padding-right: 20px; margin-top: 8px;"><a href="<?php echo $_forumrow_val['U_VIEWFORUM']; ?>"><?php echo $_forumrow_val['FORUM_NAME']; ?></a><?php } else { ?><div style="padding-right: 20px; margin-top: 8px; font-weight: bold; font-family: Tahoma, Geneva, sans-serif; text-shadow: 2px 2px 2px #0b2534;"><?php echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); ?></div><?php } ?></div></dt>
                   <a href="#" onclick="ca_expand_forum(this, <?php echo $_forumrow_val['FORUM_ID']; ?>); return false;" class="forum-expand" id="forumblock<?php echo $_forumrow_val['FORUM_ID']; ?>" <?php if (! $_forumrow_val['S_IS_CAT']) {  ?>style="display: none;"<?php } ?>></a>

						</dl>
                    
                    </div> <!-- custom cat header -->
				</li>
			</ul>    <div class="custom-row" id="<?php echo $_forumrow_val['FORUM_ID']; ?>">
		...
		<li class="row">
			<dl class="icon" style="background-image: url(<?php echo $_forumrow_val['FORUM_FOLDER_IMG_SRC']; ?>); background-repeat: no-repeat;">
                ...
                <dd class="lastpost"><span>
					...
					<dd class="topics"><?php echo $_forumrow_val['TOPICS']; ?><br /><span><?php echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); ?></span><dfn><?php echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); ?></dfn></dd>
					<dd class="posts"><?php echo $_forumrow_val['POSTS']; ?><br /><span><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?></span><dfn><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?></dfn></dd>
				<?php } ?>
